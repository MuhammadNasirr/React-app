...
import { initialPendingWithdrawalState, pendingWithdrawalsReducer } from './reducer';
...
describe('Withdrawals reducer', () => {
    ...
    it('should handle GET_WITHDRAWALS_FETCH', () => {
        const expectedState = {
            ...initialPendingWithdrawalState,
        };
        const payload = {
            page: 0,
            limit: 10
        };
        expect(pendingWithdrawalsReducer(initialPendingWithdrawalState, actions.getPendingWithdrawals(payload))).toEqual(expectedState);
    });

    it('should handle GET_WITHDRAWALS_SUCCESS', () => {
        const payload: actions.PendingWithdrawalsSuccessPayload = {
        ...
        expect(pendingWithdrawalsReducer(initialPendingWithdrawalState, actions.pendingWithdrawalsData(payload))).toEqual(expectedState);
    });
});
