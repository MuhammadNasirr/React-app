...
describe('Open Orders actions', () => {
    it('should check getOpenOrders action creator', () => {
        ...
        expect(actions.getBuyOrders(payload)).toEqual(expectedAction);
    });
    ...
    it('should check openOrdersData action creator', () => {
        ...
        expect(actions.buyOrdersData(payload)).toEqual(expectedAction);
    });
    ...
    it('should check cancelOpenOrdersData action creator', () => {
        ...
        expect(actions.cancelBuyOrder(payload)).toEqual(expectedAction);
    });
});
