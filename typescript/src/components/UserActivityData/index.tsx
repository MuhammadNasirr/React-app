...
export interface UserActivityDataProps {
...
type Props = StyleProps & UserActivityDataProps;

class UserActivityComponent extends React.Component<Props> {
    public render() {
        const {
            userActivity,
            rowsPerPage,
...
export const UserActivityData = withStyles(styles)(UserActivityComponent);
