                        ...
                        {users && users.map((user: UserInterface) => {
                            return (
                                <TableRow hover={true} key={user.uid}>
                                    ...
                                    <TableCell>{user.profiles && user.profiles.length && `${user.profiles[0].first_name} ${user.profiles[0].last_name}`}</TableCell>
                                    <TableCell>{user.profiles && user.profiles.length && user.profiles[0].country}</TableCell>
