...
class FiatScreen extends React.Component<Props, FiatState> {
    ...
    public componentDidMount() {
        ...
        this.props.getPendingWithdrawals({ page: page + 1, limit: rowsPerPage / 2, type: 'fiat', ordering: 'desc' });
    }
    ...
    private handleGetWithdrawals = (limit: number, page: number) => {
        this.props.getPendingWithdrawals({ limit, page: page + 1, type: 'fiat', ordering: 'desc' });
    }
