...
class CoinScreen extends React.Component<Props, DepositState> {
    ...
    public componentDidMount() {
        ...
        this.props.getDeposits({ page: page + 1, limit: rowsPerPage, ordering: 'desc', type: 'coin' });
    ...
    private handleGetDeposits = (limit: number, page: number) => {
        this.props.getDeposits({ limit, page: page + 1, ordering: 'desc', type: 'coin' });
    }
