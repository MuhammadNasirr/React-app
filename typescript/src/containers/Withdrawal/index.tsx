...
class WithdrawalScreen extends React.Component<Props, WithdrawalState> {
    ...
    private tabRows = [
        {
            key: 1,
            label: 'Coin',
            pathname: `${root()}/accountings/withdrawals/coin`
        },
        {
            key: 2,
            label: 'Fiat (MXN)',
            pathname: `${root()}/accountings/withdrawals/fiat-mxn`
        },
        {
            key: 3,
            label: 'Fiat',
            pathname: `${root()}/accountings/withdrawals/fiat`
        }
    ];

    private value = [
        `${root()}/accountings/withdrawals/coin`,
        `${root()}/accountings/withdrawals/fiat-mxn`,
        `${root()}/accountings/withdrawals/fiat`,
    ];
        ...
        return (
            <React.Fragment>
                ...
                >
                    <Switch>
                        <Route
                            path={`${root()}/accountings/withdrawals/coin`}
                        ...
                        />
                        <Route
                            path={`${root()}/accountings/withdrawals/fiat-mxn`}
                        ...
                        />
                        <Route
                            path={`${root()}/accountings/withdrawals/fiat`}
...
// tslint:disable-next-line:no-any
export const WithdrawalWrapper = withStyles(styles)(WithdrawalScreen);
