...
class FiatScreen extends React.Component<Props, FiatState> {
    ...
    public componentDidMount() {
        ...
        this.props.getWithdrawals({ page: page + 1, limit: rowsPerPage, type: 'fiat', ordering: 'desc' });
    }
    ...
    private handleGetWithdrawals = (limit: number, page: number) => {
        this.props.getWithdrawals({ limit, page: page + 1, type: 'fiat', ordering: 'desc' });
    }
...
const mapStateToProps: MapStateToProps<ReduxProps, {}, AppState> =
    (state: AppState): ReduxProps => ({
        ...
        loading: selectWithdrawalsLoading(state),
