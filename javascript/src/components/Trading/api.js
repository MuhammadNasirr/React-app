...
import { klineArrayToObject, periodMinutesToString } from '../../utils/helper';
import { peatioUrl } from '../../config';

const tradeUrl = peatioUrl();
...
export const dataFeedObject = (tradingChart, markets) => {
    const dataFeed = {
        ...
        searchSymbols: (onResultReadyCallback) => {
